  ...
  return (
    <Container maxW="full" py={8}>
      ...
      <Text color={{ base: "#d1d5db", _light: "#6b7280" }} mb={6}>
        Track customer invoices, outstanding debts, payment history, and aging reports.
      </Text>

      {/* Filters */}
      <Box mb={6} p={4} bg={{ base: "#1a1d29", _light: "#ffffff" }} borderRadius="lg" border="1px solid" borderColor={{ base: "rgba(255, 255, 255, 0.08)", _light: "#e5e7eb" }}>
                ...
                debts.map((debt) => (
                  <Table.Row key={debt.id}>
                    ...
                    <Table.Cell color={{ base: "#ffffff", _light: "#1a1d29" }}>
                      {formatCurrency(parseFloat(debt.amount?.toString() || "0"))}
                    </Table.Cell>
                    <Table.Cell color={{ base: "#ffffff", _light: "#1a1d29" }}>
                      {formatCurrency(parseFloat(debt.amount_paid?.toString() || "0"))}
                    </Table.Cell>
                    <Table.Cell color={{ base: "#ffffff", _light: "#1a1d29" }} fontWeight="medium">
