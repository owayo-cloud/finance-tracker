#!/bin/bash
# Advanced Server Cleanup Script for Linode
# This script includes option to remove Docker images as well
# WARNING: This will delete all data including databases and Docker images!
...
echo "=========================================="
echo "Advanced Server Cleanup Script"
echo "=========================================="
echo ""
...
echo ""
read -p "Also remove all Docker images? (yes/no): " remove_images

if [ "$remove_images" != "yes" ] && [ "$remove_images" != "no" ]; then
...
if [ "$remove_images" = "yes" ]; then
    ...
    echo "Step 6: Skipping Docker images removal..."
    echo "----------------------------------------"
    echo "Docker images preserved"
fi

echo ""
echo "Step 7: Cleaning up Docker system..."
echo "----------------------------------------"
