...
def upgrade() -> None:
    ...
    op.create_table(
        "till_shift",
        sa.Column(
            "shift_type", sqlmodel.sql.sqltypes.AutoString(length=20), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "variance_type", sqlmodel.sql.sqltypes.AutoString(length=20), nullable=False
        ),
        sa.Column(
            "notes", sqlmodel.sql.sqltypes.AutoString(length=2000), nullable=True
        ),
    ...
    )  # Drop credit_note first (depends on sale_transaction)
    op.execute(
        "DROP TABLE IF EXISTS sale_item CASCADE"
    )  # Drop sale_item (depends on sale_transaction)
    ...
    )  # Now safe to drop sale_transaction
    op.execute("DROP INDEX IF EXISTS ix_suspended_sale_suspended_at")
    op.execute(
        "DROP TABLE IF EXISTS suspended_sale CASCADE"
    )  # Drop suspended_sale (depends on customer)
    ...
    op.add_column(
        "shift_reconciliation", sa.Column("till_shift_id", sa.Uuid(), nullable=True)
    )
    op.create_foreign_key(
        None, "shift_reconciliation", "till_shift", ["till_shift_id"], ["id"]
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_index(
        op.f("idx_supplier_product_reorder_supplier_id"),
        "supplier_product_reorder",
        ["supplier_id"],
        unique=False,
    )
    op.create_index(
        op.f("idx_supplier_product_reorder_product_id"),
        "supplier_product_reorder",
        ["product_id"],
        unique=False,
    )
    op.create_index(
        op.f("idx_supplier_product_reorder_active"),
        "supplier_product_reorder",
        ["is_active"],
        unique=False,
    )
    op.create_index(
        op.f("idx_supplier_debt_payment_installment_id"),
        "supplier_debt_payment",
        ["installment_id"],
        unique=False,
    )
    op.create_index(
        op.f("idx_supplier_debt_payment_debt_id"),
        "supplier_debt_payment",
        ["supplier_debt_id"],
        unique=False,
    )
    op.create_index(
        op.f("idx_supplier_debt_payment_date"),
        "supplier_debt_payment",
        ["payment_date"],
        unique=False,
    )
    op.create_index(
        op.f("idx_supplier_debt_installment_status"),
        "supplier_debt_installment",
        ["status"],
        unique=False,
    )
    op.create_index(
        op.f("idx_supplier_debt_installment_due_date"),
        "supplier_debt_installment",
        ["due_date"],
        unique=False,
    )
    op.create_index(
        op.f("idx_supplier_debt_installment_debt_id"),
        "supplier_debt_installment",
        ["supplier_debt_id"],
        unique=False,
    )
    op.create_index(
        op.f("idx_supplier_debt_supplier_id"),
        "supplier_debt",
        ["supplier_id"],
        unique=False,
    )
    op.create_index(
        op.f("idx_supplier_debt_status"), "supplier_debt", ["status"], unique=False
    )
    op.create_index(
        op.f("idx_supplier_debt_is_overdue"),
        "supplier_debt",
        ["is_overdue"],
        unique=False,
    )
    op.create_index(
        op.f("idx_supplier_debt_grn_id"), "supplier_debt", ["grn_id"], unique=False
    )
    op.create_index(
        op.f("idx_supplier_debt_due_date"), "supplier_debt", ["due_date"], unique=False
    )
    op.drop_constraint(None, "shift_reconciliation", type_="foreignkey")  # type: ignore[arg-type]
    op.drop_column("shift_reconciliation", "till_shift_id")
    op.create_index(
        op.f("idx_reminder_setting_user_id"),
        "reminder_setting",
        ["user_id"],
        unique=False,
    )
    op.create_index(
        op.f("idx_reminder_setting_type"),
        "reminder_setting",
        ["reminder_type"],
        unique=False,
    )
    op.create_index(
        op.f("idx_reminder_setting_next_send"),
        "reminder_setting",
        ["next_send_at"],
        unique=False,
    )
    op.create_index(
        op.f("idx_reminder_setting_enabled"),
        "reminder_setting",
        ["is_enabled"],
        unique=False,
    )
    op.create_index(
        op.f("idx_reminder_log_user_id"), "reminder_log", ["user_id"], unique=False
    )
    op.create_index(
        op.f("idx_reminder_log_status"), "reminder_log", ["status"], unique=False
    )
    op.create_index(
        op.f("idx_reminder_log_setting_id"),
        "reminder_log",
        ["reminder_setting_id"],
        unique=False,
    )
    op.create_index(
        op.f("idx_reminder_log_sent_at"), "reminder_log", ["sent_at"], unique=False
    )
    op.create_index(
        op.f("idx_product_last_reorder_alert_sent"),
        "product",
        ["last_reorder_alert_sent"],
        unique=False,
    )
    op.create_index(
        op.f("idx_product_enable_reorder_alerts"),
        "product",
        ["enable_reorder_alerts"],
        unique=False,
    )
    op.create_index(
        op.f("idx_notification_user_id"), "notification", ["user_id"], unique=False
    )
    op.create_index(
        op.f("idx_notification_type"),
        "notification",
        ["notification_type"],
        unique=False,
    )
    op.create_index(
        op.f("idx_notification_priority"), "notification", ["priority"], unique=False
    )
    op.create_index(
        op.f("idx_notification_is_read"), "notification", ["is_read"], unique=False
    )
    op.create_index(
        op.f("idx_notification_created_at"),
        "notification",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("idx_grn_requires_approval"), "grn", ["requires_approval"], unique=False
    )
    ...
    op.create_table(
        "cash_movement",
        sa.Column(
            "movement_type", sa.VARCHAR(length=50), autoincrement=False, nullable=False
        ),
        ...
        sa.Column(
            "movement_date", postgresql.TIMESTAMP(), autoincrement=False, nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["created_by_id"],
            ["user.id"],
            name=op.f("cash_movement_created_by_id_fkey"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("cash_movement_pkey")),
    )
    op.create_index(
        op.f("ix_cash_movement_movement_date"),
        "cash_movement",
        ["movement_date"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "discount_percent", sa.NUMERIC(), autoincrement=False, nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["product_id"], ["product.id"], name=op.f("sale_item_product_id_fkey")
        ),
        sa.ForeignKeyConstraint(
            ["transaction_id"],
            ["sale_transaction.id"],
            name=op.f("sale_item_transaction_id_fkey"),
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "receipt_number", sa.VARCHAR(length=50), autoincrement=False, nullable=True
        ),
        sa.Column("notes", sa.VARCHAR(length=1000), autoincrement=False, nullable=True),
        ...
        sa.Column(
            "void_reason", sa.VARCHAR(length=500), autoincrement=False, nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["created_by_id"], ["user.id"], name="sale_transaction_created_by_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["customer_id"], ["customer.id"], name="sale_transaction_customer_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["payment_method_id"],
            ["payment_method.id"],
            name="sale_transaction_payment_method_id_fkey",
        ),
        sa.PrimaryKeyConstraint("id", name="sale_transaction_pkey"),
        postgresql_ignore_search_path=False,
    )
    op.create_index(
        op.f("ix_sale_transaction_transaction_date"),
        "sale_transaction",
        ["transaction_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_sale_transaction_receipt_number"),
        "sale_transaction",
        ["receipt_number"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column("created_by_id", sa.UUID(), autoincrement=False, nullable=False),
        sa.ForeignKeyConstraint(
            ["created_by_id"], ["user.id"], name=op.f("credit_note_created_by_id_fkey")
        ),
        sa.ForeignKeyConstraint(
            ["customer_id"], ["customer.id"], name=op.f("credit_note_customer_id_fkey")
        ),
        sa.ForeignKeyConstraint(
            ["original_sale_id"],
            ["sale_transaction.id"],
            name=op.f("credit_note_original_sale_id_fkey"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("credit_note_pkey")),
        sa.UniqueConstraint(
            "credit_note_number", name=op.f("credit_note_credit_note_number_key")
        ),
    )
    op.create_index(
        op.f("ix_credit_note_credit_note_number"),
        "credit_note",
        ["credit_note_number"],
        unique=True,
    )
    op.create_table(
        ...
        sa.Column("id", sa.UUID(), autoincrement=False, nullable=False),
        sa.Column(
            "suspended_at", postgresql.TIMESTAMP(), autoincrement=False, nullable=False
        ),
        sa.Column("created_by_id", sa.UUID(), autoincrement=False, nullable=False),
        sa.Column(
        ...
        sa.ForeignKeyConstraint(
            ["created_by_id"],
            ["user.id"],
            name=op.f("suspended_sale_created_by_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["customer_id"],
            ["customer.id"],
            name=op.f("suspended_sale_customer_id_fkey"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("suspended_sale_pkey")),
    )
    op.create_index(
        op.f("ix_suspended_sale_suspended_at"),
        "suspended_sale",
        ["suspended_at"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "contact", sa.VARCHAR(length=100), autoincrement=False, nullable=True
        ),
        ...
        sa.Column(
            "customer_pin", sa.VARCHAR(length=50), autoincrement=False, nullable=True
        ),
