    ...
    >
      <HStack justify="space-between" mb={4}>
        ...
        {recentSales.length > 0 && (
          ...
          >
            <HStack gap={1}>
              <Text fontSize="xs" color={{ base: "#14b8a6", _light: "#009688" }} fontWeight="500">
                View All
              </Text>
              <Icon as={FiArrowRight} fontSize="xs" color={{ base: "#14b8a6", _light: "#009688" }} />
            </HStack>
          </Link>
        )}
      </HStack>
      ...
      <VStack gap={3} align="stretch" maxH="400px" overflowY="auto">
        {activities.length > 0 ? (
              ...
              <HStack gap={3} justify="space-between">
                <HStack gap={3} flex={1}>
                  <Box
                    p={2}
                    borderRadius="md"
                    bg={{ base: "rgba(239, 68, 68, 0.1)", _light: "rgba(239, 68, 68, 0.05)" }}
                    border="1px solid"
                    borderColor={{ base: "rgba(239, 68, 68, 0.2)", _light: "rgba(239, 68, 68, 0.1)" }}
                  >
                ...
                <VStack align="end" gap={0}>
                  <Text fontSize="sm" fontWeight="700" color={{ base: "#10b981", _light: "#059669" }}>
          ...
          >
            ...
            <Text fontSize="xs" color={{ base: "#6b7280", _light: "#9ca3af" }} mt={1}>
