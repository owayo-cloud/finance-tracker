...
export function TransactionHistory({ recentSales, totalRevenue }: TransactionHistoryProps) {
  return (
    <Box 
      p={6} 
      ...
      <Box mb={4} display="flex" justifyContent="center" alignItems="center">
        ...
        >
          <VStack gap={0}>
            ...
            <Text fontSize="xs" color={{ base: "#9ca3af", _light: "#6b7280" }}>Total</Text>
          </VStack>
        </Box>
      </Box>
        ...
        {recentSales.slice(0, 3).map((sale) => (
          ...
          >
            <HStack justify="space-between">
              ...
              <Text fontSize="sm" fontWeight="700" color={{ base: "#ffffff", _light: "#1a1d29" }}>
