...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "link_url", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        sa.Column(
            "link_text", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.Uuid(), nullable=False),
        sa.Column(
            "reminder_type", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        sa.Column("is_enabled", sa.Boolean(), nullable=False),
        sa.Column(
            "frequency", sqlmodel.sql.sqltypes.AutoString(length=20), nullable=False
        ),
        sa.Column(
            "send_time", sqlmodel.sql.sqltypes.AutoString(length=8), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "subject_line", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        sa.Column("extra_data", sa.JSON(), nullable=True),
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("created_at", sa.DateTime(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "payment_terms", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
    ...
    op.add_column(
        "grn",
        sa.Column(
            "credit_terms", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True
        ),
    )
    op.add_column(
        "grn",
    ...
    op.add_column(
        "grn",
        sa.Column("creates_debt", sa.Boolean(), server_default="false", nullable=False),
    )

    # Add Product columns with defaults for existing rows
    op.add_column(
        "product", sa.Column("reorder_quantity", sa.Numeric(scale=2), nullable=True)
    )
    op.add_column(
        "product",
        sa.Column(
    ...
    op.add_column(
        "product", sa.Column("last_reorder_alert_sent", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "product",
        sa.Column(
            "consecutive_reorder_alerts",
            sa.Integer(),
            server_default="0",
            nullable=False,
        ),
    ...
    op.add_column(
        "product",
        sa.Column(
            "max_consecutive_alerts", sa.Integer(), server_default="5", nullable=False
        ),
    )
    ...
    op.add_column(
        "supplier",
        sa.Column(
            "credit_limit", sa.Numeric(scale=2), server_default="0", nullable=False
        ),
    )
    op.add_column(
        "supplier",
    ...
    op.add_column(
        "user",
        sa.Column(
            "receives_grn_approval_requests",
            sa.Boolean(),
            server_default="false",
            nullable=False,
        ),
    ...
    op.create_index(
        "idx_supplier_debt_payment_debt_id",
        "supplier_debt_payment",
        ["supplier_debt_id"],
    )
    op.create_index(
        "idx_supplier_debt_payment_installment_id",
        "supplier_debt_payment",
        ["installment_id"],
    )
    op.create_index(
        "idx_supplier_debt_payment_date", "supplier_debt_payment", ["payment_date"]
    )

    # Supplier Debt Installment indexes
    op.create_index(
        "idx_supplier_debt_installment_debt_id",
        "supplier_debt_installment",
        ["supplier_debt_id"],
    )
    op.create_index(
        "idx_supplier_debt_installment_status", "supplier_debt_installment", ["status"]
    )
    op.create_index(
        "idx_supplier_debt_installment_due_date",
        "supplier_debt_installment",
        ["due_date"],
    )
    ...
    op.create_index(
        "idx_reminder_setting_next_send", "reminder_setting", ["next_send_at"]
    )

    # Reminder Log indexes
    op.create_index("idx_reminder_log_user_id", "reminder_log", ["user_id"])
    op.create_index(
        "idx_reminder_log_setting_id", "reminder_log", ["reminder_setting_id"]
    )
    ...
    op.create_index(
        "idx_supplier_product_reorder_supplier_id",
        "supplier_product_reorder",
        ["supplier_id"],
    )
    op.create_index(
        "idx_supplier_product_reorder_product_id",
        "supplier_product_reorder",
        ["product_id"],
    )
    op.create_index(
        "idx_supplier_product_reorder_active", "supplier_product_reorder", ["is_active"]
    )

    # Product reorder alert indexes
    op.create_index(
        "idx_product_enable_reorder_alerts", "product", ["enable_reorder_alerts"]
    )
    op.create_index(
        "idx_product_last_reorder_alert_sent", "product", ["last_reorder_alert_sent"]
    )
...
def downgrade() -> None:
    ...
    op.execute(
        "ALTER TABLE supplier DROP CONSTRAINT IF EXISTS chk_supplier_credit_used"
    )
    op.execute(
        "ALTER TABLE supplier_debt_installment DROP CONSTRAINT IF EXISTS chk_installment_amounts"
    )
    op.execute(
        "ALTER TABLE supplier_debt_installment DROP CONSTRAINT IF EXISTS chk_installment_balance"
    )
    op.execute(
        "ALTER TABLE supplier_debt DROP CONSTRAINT IF EXISTS chk_supplier_debt_amounts"
    )
    op.execute(
        "ALTER TABLE supplier_debt DROP CONSTRAINT IF EXISTS chk_supplier_debt_balance"
    )
    ...
    op.drop_index(
        "idx_supplier_product_reorder_active", table_name="supplier_product_reorder"
    )
    op.drop_index(
        "idx_supplier_product_reorder_product_id", table_name="supplier_product_reorder"
    )
    op.drop_index(
        "idx_supplier_product_reorder_supplier_id",
        table_name="supplier_product_reorder",
    )
    ...
    op.drop_index(
        "idx_supplier_debt_installment_due_date", table_name="supplier_debt_installment"
    )
    op.drop_index(
        "idx_supplier_debt_installment_status", table_name="supplier_debt_installment"
    )
    op.drop_index(
        "idx_supplier_debt_installment_debt_id", table_name="supplier_debt_installment"
    )
    op.drop_index("idx_supplier_debt_payment_date", table_name="supplier_debt_payment")
    op.drop_index(
        "idx_supplier_debt_payment_installment_id", table_name="supplier_debt_payment"
    )
    op.drop_index(
        "idx_supplier_debt_payment_debt_id", table_name="supplier_debt_payment"
    )
