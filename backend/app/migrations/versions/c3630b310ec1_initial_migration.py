...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_expense_category_name'), 'expense_category', ['name'], unique=True)
    ...
    op.create_index(op.f('ix_product_status_name'), 'product_status', ['name'], unique=True)
    ...
    sa.ForeignKeyConstraint(['status_id'], ['product_status.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_product_name'), 'product', ['name'], unique=False)
    op.create_table('shift_reconciliation',
    ...
    op.create_index(op.f('ix_shift_reconciliation_shift_date'), 'shift_reconciliation', ['shift_date'], unique=False)
    ...
    op.create_index(op.f('ix_stock_entry_entry_date'), 'stock_entry', ['entry_date'], unique=False)
    op.create_table('debt',
    sa.Column('customer_name', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
    sa.Column('customer_contact', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True),
    ...
    op.create_index(op.f('ix_debt_customer_name'), 'debt', ['customer_name'], unique=False)
    ...
    op.create_index(op.f('ix_debt_payment_payment_date'), 'debt_payment', ['payment_date'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_table('sale')
    op.drop_index(op.f('ix_shift_reconciliation_shift_date'), table_name='shift_reconciliation')
