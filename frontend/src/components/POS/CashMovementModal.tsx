...
import { Textarea, SelectRoot, SelectTrigger, SelectContent, SelectItem, SelectValueText, createListCollection } from "@chakra-ui/react"
...
export function CashMovementModal({
  ...
  const onSubmit: SubmitHandler<CashMovementForm> = async (data) => {
    try {
      ...
      const movements = JSON.parse(localStorage.getItem("cash_movements") || "[]")
            ...
            <VStack gap={4}>
              ...
              >
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem item={{ label: "Cash In", value: "in" }}>Cash In</SelectItem>
                    <SelectItem item={{ label: "Cash Out", value: "out" }}>Cash Out</SelectItem>
                  </SelectContent>
                </SelectRoot>
              </Field>
              <Field
