...
def create_supplier_debt(
    ...
    **Access**: Admin only
    ...
    crud.create_notification_for_admins(
        ...
        title="New Supplier Debt Created",
...
def list_installments(
    ...
    **Access**: Admin, Auditor
    ...
    return SupplierDebtInstallmentsPublic(data=installments, count=len(installments))
...
def create_installments(
    ...
    **Access**: Admin only
    ...
    if not current_user.is_superuser and current_user.role != "admin":
        raise HTTPException(
            status_code=403, detail="Only admin can create installments"
        )
