...
def upgrade():
    ...
    op.drop_index(op.f('ix_credit_note_credit_note_number'), table_name='credit_note')
    op.drop_table('credit_note')  # Drop credit_note first (depends on sale_transaction)
    op.drop_table('sale_item')  # Drop sale_item (depends on sale_transaction)
    op.drop_index(op.f('ix_sale_transaction_receipt_number'), table_name='sale_transaction')
    op.drop_index(op.f('ix_sale_transaction_transaction_date'), table_name='sale_transaction')
    op.drop_table('sale_transaction')  # Now safe to drop sale_transaction
    op.drop_index(op.f('ix_suspended_sale_suspended_at'), table_name='suspended_sale')
    op.drop_table('suspended_sale')  # Drop suspended_sale (depends on customer)
    op.drop_index(op.f('ix_customer_name'), table_name='customer')
    op.drop_table('customer')  # Drop customer last
    op.drop_index(op.f('ix_cash_movement_movement_date'), table_name='cash_movement')
    op.drop_table('cash_movement')
    op.drop_index(op.f('idx_grn_creates_debt'), table_name='grn')
    op.drop_index(op.f('idx_grn_payment_type'), table_name='grn')
    op.drop_index(op.f('idx_grn_requires_approval'), table_name='grn')
    op.drop_index(op.f('idx_notification_created_at'), table_name='notification')
    op.drop_index(op.f('idx_notification_is_read'), table_name='notification')
    op.drop_index(op.f('idx_notification_priority'), table_name='notification')
    op.drop_index(op.f('idx_notification_type'), table_name='notification')
    op.drop_index(op.f('idx_notification_user_id'), table_name='notification')
    op.drop_index(op.f('idx_product_enable_reorder_alerts'), table_name='product')
    op.drop_index(op.f('idx_product_last_reorder_alert_sent'), table_name='product')
    op.drop_index(op.f('idx_reminder_log_sent_at'), table_name='reminder_log')
    op.drop_index(op.f('idx_reminder_log_setting_id'), table_name='reminder_log')
    op.drop_index(op.f('idx_reminder_log_status'), table_name='reminder_log')
    op.drop_index(op.f('idx_reminder_log_user_id'), table_name='reminder_log')
    op.drop_index(op.f('idx_reminder_setting_enabled'), table_name='reminder_setting')
    op.drop_index(op.f('idx_reminder_setting_next_send'), table_name='reminder_setting')
    op.drop_index(op.f('idx_reminder_setting_type'), table_name='reminder_setting')
    op.drop_index(op.f('idx_reminder_setting_user_id'), table_name='reminder_setting')
    ...
    op.drop_index(op.f('idx_supplier_debt_due_date'), table_name='supplier_debt')
    op.drop_index(op.f('idx_supplier_debt_grn_id'), table_name='supplier_debt')
    op.drop_index(op.f('idx_supplier_debt_is_overdue'), table_name='supplier_debt')
    op.drop_index(op.f('idx_supplier_debt_status'), table_name='supplier_debt')
    op.drop_index(op.f('idx_supplier_debt_supplier_id'), table_name='supplier_debt')
    op.drop_index(op.f('idx_supplier_debt_installment_debt_id'), table_name='supplier_debt_installment')
    op.drop_index(op.f('idx_supplier_debt_installment_due_date'), table_name='supplier_debt_installment')
    op.drop_index(op.f('idx_supplier_debt_installment_status'), table_name='supplier_debt_installment')
    op.drop_index(op.f('idx_supplier_debt_payment_date'), table_name='supplier_debt_payment')
    op.drop_index(op.f('idx_supplier_debt_payment_debt_id'), table_name='supplier_debt_payment')
    op.drop_index(op.f('idx_supplier_debt_payment_installment_id'), table_name='supplier_debt_payment')
    op.drop_index(op.f('idx_supplier_product_reorder_active'), table_name='supplier_product_reorder')
    op.drop_index(op.f('idx_supplier_product_reorder_product_id'), table_name='supplier_product_reorder')
    op.drop_index(op.f('idx_supplier_product_reorder_supplier_id'), table_name='supplier_product_reorder')
